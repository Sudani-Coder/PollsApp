...
def seed_users(num_entries=9, overwrite=False):
    """
...
def seed_question(num_entries=10, choice_min=2, choice_max=5, overwrite=False):
    """
...
def seed_votes():
    ...
    count = 0
    number_of_new_votes = users.count() * questions.count()
